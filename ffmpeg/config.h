...
#define FFMPEG_CONFIGURATION "--target-os=none --arch=x86_32 --enable-cross-compile --disable-x86asm --disable-inline-asm --disable-stripping --disable-programs --disable-doc --extra-cflags=-sUSE_PTHREADS --extra-cxxflags=-sUSE_PTHREADS --extra-ldflags='-sUSE_PTHREADS-sINITIAL_MEMORY=33554432' --nm=/Users/koolearn/Desktop/ramedia/emsdk/upstream/bin/llvm-nm --ar=emar --ranlib=emranlib --cc=emcc --cxx=em++ --objcc=emcc --dep-cc=emcc"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 3.1.42-git"
#define OS_NAME none
