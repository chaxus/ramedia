...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=none --arch=x86_32 --enable-cross-compile --disable-x86asm --disable-inline-asm --disable-stripping --disable-programs --disable-doc --extra-cflags=-sUSE_PTHREADS --extra-cxxflags=-sUSE_PTHREADS --extra-ldflags='-sUSE_PTHREADS-sINITIAL_MEMORY=33554432' --nm=/Users/koolearn/Desktop/ramedia/emsdk/upstream/bin/llvm-nm --ar=emar --ranlib=emranlib --cc=emcc --cxx=em++ --objcc=emcc --dep-cc=emcc
prefix=/usr/local
...
CC_IDENT=emcc (Emscripten gcc/clang-like replacement + linker emulating GNU ld) 3.1.42-git
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=emcc
...
AR_O=$@
AR_CMD=emar
NM_CMD=/Users/koolearn/Desktop/ramedia/emsdk/upstream/bin/llvm-nm
...
CFLAGS=  -sUSE_PTHREADS -std=c11 -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -sUSE_SDL=2
CXXFLAGS= -sUSE_PTHREADS -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -sUSE_PTHREADS -g -Qunused-arguments
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -sUSE_PTHREADS-sINITIAL_MEMORY=33554432  -Wl,-z,noexecstack -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -sUSE_SDL=2
